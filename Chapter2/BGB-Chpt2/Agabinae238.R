...
geogfn = np("Agabinae_ecoregion6_238.data")
...
BioGeoBEARS_run_object$timesfn = "Agabinae_timeperiods_S7.txt"
BioGeoBEARS_run_object$dispersal_multipliers_fn = "Agabinae_multipliers_Afr6_S7.txt"
BioGeoBEARS_run_object$areas_allowed_fn = "Agabinae_areas_allowed_Afr6_S7.txt"
BioGeoBEARS_run_object$areas_adjacency_fn = "Agabinae_adjacency_Afr6_S7.txt"
...
runslow = TRUE
resfn = "Agabinae238_unconstrained_v1.Rdata"
if (runslow)
{
...
resfn = "Agabinae238_DEC+J_M0_unconstrained_v1.Rdata"
runslow = TRUE
if (runslow)
{
...
# PDF plots
#######################################################
pdffn = "Agabinae238_DEC_vs_DEC+J_M0_unconstrained_v1.pdf"
pdf(pdffn, width=10, height=25)

#######################################################
# Plot ancestral states - DEC
#######################################################
analysis_titletxt ="BioGeoBEARS DEC on Agabinae238 M0_unconstrained"
...
#######################################################
analysis_titletxt ="BioGeoBEARS DEC+J on Agabus101_S23 M0_unconstrained"
...
runslow = TRUE
resfn = "Agabinae238_DIVALIKE_M0_unconstrained_v1.Rdata"
if (runslow)
{
  res = bears_optim_run(BioGeoBEARS_run_object)
  res    
...
resfn = "Agabinae238_DIVALIKE+J_M0_unconstrained_v1.Rdata"
runslow = TRUE
if (runslow)
{
  #sourceall("/Dropbox/_njm/__packages/BioGeoBEARS_setup/")
...
pdffn = "Agabinae238_DIVALIKE_vs_DIVALIKE+J_M0_unconstrained_v1.pdf"
pdf(pdffn, width=10, height=25)

#######################################################
# Plot ancestral states - DIVALIKE
#######################################################
analysis_titletxt ="BioGeoBEARS DIVALIKE on Agabinae238 M0_unconstrained"
...
#######################################################
analysis_titletxt ="BioGeoBEARS DIVALIKE+J on Agabinae238 M0_unconstrained"
...
runslow = TRUE
resfn = "Agabinae238_BAYAREALIKE_M0_unconstrained_v1.Rdata"
if (runslow)
{
  res = bears_optim_run(BioGeoBEARS_run_object)
  res    
...
resfn = "Agabinae238_BAYAREALIKE+J_M0_unconstrained_v1.Rdata"
runslow = TRUE
if (runslow)
{
  res = bears_optim_run(BioGeoBEARS_run_object)
...
pdffn = "Agabinae238_BAYAREALIKE_vs_BAYAREALIKE+J_M0_unconstrained_v1.pdf"
pdf(pdffn, width=10, height=25)

#######################################################
# Plot ancestral states - BAYAREALIKE
#######################################################
analysis_titletxt ="BioGeoBEARS BAYAREALIKE on Agabinae238 M0_unconstrained"
...
#######################################################
analysis_titletxt ="BioGeoBEARS BAYAREALIKE+J on Agabinae238 M0_unconstrained"
